(function($) {
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2021/12/19', function(event) {
            var $this = $(this).html(event.strftime(''
            + '<div class="box" style="border-color:#ffd770; background-color:#a0a88b"><div>%D</div> <span>Days</span> </div>'
            + '<div class="box" style="border-color:#ffd770; background-color:#a0a88b"><div>%H</div> <span>Hours</span> </div>'
            + '<div class="box" style="border-color:#ffd770; background-color:#a0a88b"><div>%M</div> <span>Mins</span> </div>'
            + '<div class="box" style="border-color:#ffd770; background-color:#a0a88b"><div>%S</div> <span>Secs</span> </div>'));
        });
    }
